...
// import "./TarifDetaySkeleton.css"; // Skeleton için ayrı stil dosyası
...
//         <h1 className="tarif-detay-title">{recipe.name}</h1>
//       </div>
...
//       </div>
//       <div className="tarif-detay-footer">
